...
namespace Infrastructure.Reponsitories.Implementations
{
    public class FunctionRoleRepository : AsyncGenericRepository<FunctionRole, int>, IFunctionRoleRepository
    {
        ...
        public FunctionRoleRepository(AppDbContext context, IUserContext userContext, ElasticsearchClient elasticsearchClient) : base(context, userContext, elasticsearchClient)
        {
            _context = context;
