...
namespace Infrastructure.Reponsitories.Implementations
{
    public class FunctionRepository : AsyncGenericRepository<Function, int>, IFunctionRepository
    {
        ...
        public FunctionRepository(AppDbContext context, IUserContext userContext, ElasticsearchClient elasticsearchClient) : base(context, userContext, elasticsearchClient)
        {
            _context = context;
