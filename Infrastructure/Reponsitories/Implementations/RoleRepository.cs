...
namespace Infrastructure.Reponsitories.Implementations
{
    public class RoleRepository : AsyncGenericRepository<Role, int>, IRoleRepository
    {
        ...
        public RoleRepository(AppDbContext context, IUserContext userContext, ElasticsearchClient elasticsearchClient) : base(context, userContext, elasticsearchClient)
        {
            _context = context;
