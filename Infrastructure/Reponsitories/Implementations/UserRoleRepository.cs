...
namespace Infrastructure.Reponsitories.Implementations
{
    public class UserRoleRepository : AsyncGenericRepository<UserRole, int>, IUserRoleRepository
    {
        ...
        public UserRoleRepository(AppDbContext context, IUserContext userContext, ElasticsearchClient elasticsearchClient) : base(context, userContext, elasticsearchClient)
        {
            _context = context;
