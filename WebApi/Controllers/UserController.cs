...
namespace WebApi.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetByPage(GetUserByPageCommand command)
        {
        ...
        public async Task<IActionResult> CreateData(SaveUserCommand command)
        {
            return Ok(await _mediator.Send(command));
        }
        ...
        public async Task<IActionResult> UpdateData(SaveUserCommand command)
        {
            return Ok(await _mediator.Send(command));
        }
